...
```
devnet@devnet-ThinkPad-P1-Gen-4i:~/DEVWKS-1961$ ls
```
...
```
devnet@devnet-ThinkPad-P1-Gen-4i:~/DEVWKS-1961$ ncs_cli -C -u admin
```
...
```
admin@ncs# exit
devnet@devnet-ThinkPad-P1-Gen-4i:~/DEVWKS-1961$ cd ncs-run
```

Try to change something directly on the device IOS0:
```
devnet@devnet-ThinkPad-P1-Gen-4i:~/DEVWKS-1961/ncs-run$ ncs-netsim cli-i IOS0
...
```
devnet@devnet-ThinkPad-P1-Gen-4i:~/DEVWKS-1961/ncs-run$ ncs_cli -C -u admin
